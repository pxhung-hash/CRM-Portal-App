...
export function AddNewBOM({ onClose, onSave }: AddNewBOMProps) {
  const [bomType, setBomType] = useState<"outer" | "inner" | "connector">("outer");
              ...
              <div className="grid grid-cols-3 gap-4">
                ...
                >
                  <Settings className={`h-8 w-8 mx-auto mb-2 ${
                    bomType === "connector" ? "text-purple-600" : "text-gray-400"
                  }`} />
                  <p className={`font-medium ${
                    bomType === "connector" ? "text-purple-900" : "text-gray-600"
                  }`}>
                    Connector BOM
                  </p>
                  <p className="text-xs text-gray-500 mt-1">Module connectors</p>
                </button>
              </div>
            </CardContent>
          </Card>
