...
import logoImage from "/assets/img/header_logo01.svg";
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-blue-50 flex items-center justify-center p-4">
      ...
      <div className="w-full max-w-6xl grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
        ...
        <Card className="shadow-2xl border-0">
          ...
          <CardContent>
            {/* Prominent Setup Alert */}
            <div className="mb-6 p-4 bg-gradient-to-r from-amber-50 to-orange-50 rounded-lg border-2 border-amber-300 shadow-sm">
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  <p className="text-sm font-bold text-amber-900 mb-1">⚠️ First Time Setup Required</p>
                  <p className="text-xs text-amber-800 mb-2">
                    No users exist yet! You must create test users before you can log in.
                  </p>
                  <Button 
                    type="button" 
                    size="sm"
                  ...
                  >
                    ...
                    Click Here to Create Users Now
                  </Button>
                </div>
              </div>
            </div>
