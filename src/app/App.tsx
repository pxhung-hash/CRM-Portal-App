...
import { WindowDesign } from "./components/WindowDesign";
...
import { InboundPurchasingOrders } from "./components/InboundPurchasingOrders";
...
export default function App() {
  ...
  const renderContent = () => {
    ...
    switch (activeTab) {
      ...
      case "inboundPurchasingOrders":
        return <InboundPurchasingOrders />;
      default:
        return <ProductCatalog onViewProduct={handleViewProduct} />;
    }
  };
